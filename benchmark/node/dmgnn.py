...
from pygda.models import DMGNN
...
parser.add_argument('--n_emb', type=int, default=128, help='adversarial learning module hidden dimension')
parser.add_argument('--pair_weight', type=float, default=0.1, help='trade-off hyper-parameter for pairwise constraint')
...
results = 'dmgnn,source,' + args.source + ',target,' + args.target + ',micro-f1,' + str(mi_f1) + ',macro-f1,' + str(ma_f1) + ',auc,' + str(auc)
