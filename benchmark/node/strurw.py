...
from pygda.models import StruRW
...
parser.add_argument('--gnn', type=str, default='GS', help='GNN backbone')
parser.add_argument('--lamb', type=float, default=0.8, help='trade-off parameter for edge reweight')
parser.add_argument('--mode', type=str, default='erm', help='the training mode of StruRW')
parser.add_argument('--ew_start', type=int, default=20, help='starting epoch for edge reweighting')
parser.add_argument('--ew_freq', type=int, default=20, help='frequency for edge reweighting')
...
parser.add_argument('--reweight', type=bool, default=True, help='reweight the edge in source graph or not')
parser.add_argument('--pseudo', type=bool, default=True, help='use pseudo labels in target graph or not')
...
results = 'strurw,source,' + args.source + ',target,' + args.target + ',micro-f1,' + str(mi_f1) + ',macro-f1,' + str(ma_f1) + ',auc,' + str(auc)
