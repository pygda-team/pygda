...
parser.add_argument('--source', type=str, default='USA', help='source domain data, DBLPv7/ACMv9/Citationv1')
parser.add_argument('--target', type=str, default='EUROPE', help='target domain data, DBLPv7/ACMv9/Citationv1')
parser.add_argument('--epochs', type=int, default=200, help='maximum number of epochs')
parser.add_argument('--filename', type=str, default='test.txt', help='store results into file')

# model specific params
parser.add_argument('--k_cross', type=int, default=20, help='number of edges for cross domains')
parser.add_argument('--k_within', type=int, default=6, help='number of edges for within domains')
...
results = 'kbl,source,' + args.source + ',target,' + args.target + ',micro-f1,' + str(mi_f1) + ',macro-f1,' + str(ma_f1) + ',auc,' + str(auc)
