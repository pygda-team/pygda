...
from pygda.models import ACDNE
...
parser.add_argument('--n_emb', type=int, default=128, help='hidden dimension of adversarial module')
...
results = 'acdne,source,' + args.source + ',target,' + args.target + ',micro-f1,' + str(mi_f1) + ',macro-f1,' + str(ma_f1) + ',auc,' + str(auc)
