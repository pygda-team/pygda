...
from pygda.models import SAGDA
...
parser.add_argument('--alpha', type=float, default=1.0, help='trade-off parameter for high pass filter')
parser.add_argument('--beta', type=float, default=1.0, help='trade-off parameter for low pass filter')
...
results = 'sagda,source,' + args.source + ',target,' + args.target + ',micro-f1,' + str(mi_f1) + ',macro-f1,' + str(ma_f1) + ',auc,' + str(auc)
