...
from pygda.models import JHGDA
...
parser.add_argument('--share', type=bool, default=False, help='share the diffpool module or not')
parser.add_argument('--sparse', type=bool, default=False, help='diffpool module sparse or not')
parser.add_argument('--classwise', type=bool, default=True, help='classwise conditional shift or not')
parser.add_argument('--pool_ratio', type=float, default=0.2, help='graph pooling ratio')
parser.add_argument('--g_mmd', type=float, default=0.5, help='global mmd weight')
parser.add_argument('--c_mmd', type=float, default=0.5, help='conditional mmd weight')
parser.add_argument('--d_weight', type=float, default=0.1, help='domain loss weight')
parser.add_argument('--ce_weight', type=float, default=0.1, help='cluster entropy weight')
parser.add_argument('--prox_weight', type=float, default=0.1, help='proximity loss weight')
parser.add_argument('--cce_weight', type=float, default=0.1, help='conditional cluster entropy weight')
parser.add_argument('--lm_weight', type=float, default=0.1, help='label matching weight')
parser.add_argument('--ls_weight', type=float, default=0.1, help='label stable weight')
...
results = 'jhgda,source,' + args.source + ',target,' + args.target + ',micro-f1,' + str(mi_f1) + ',macro-f1,' + str(ma_f1) + ',auc,' + str(auc)
